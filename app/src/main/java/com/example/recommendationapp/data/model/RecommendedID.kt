...
@Entity(tableName = DatabaseScheme.RestaurantsTableScheme.RECOMMENDED_IDS)
@Parcelize
@TypeConverters(Converters::class)
data class RecommendedID(
    @PrimaryKey
    ...
    companion object {
        fun fromEntity(entity: Int): RecommendedID = RecommendedID(entity)
    }
}
